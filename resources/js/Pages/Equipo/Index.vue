...
const titulos = [
    ...
    { order: 'precios_de_listas', label: 'Precios de Listas', type: 'text' },
    { order: 'ruta_tiempos', label: 'Ruta Tiempos', type: 'text' },
    { order: 'tiempos_chapisteria', label: 'Tiempos Chapisteria', type: 'number' },
];
